    ...
    <div className="min-h-screen bg-[#fafbfe] flex flex-col justify-between py-12 px-6">
      ...
      <header className="max-w-6xl w-full mx-auto flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/login" className="px-5 py-2 text-sm font-extrabold text-[#1b3151] hover:bg-[#f2bd11]/10 border border-[#f2bd11] bg-[#f2bd11]/5 rounded-[50px] transition-colors">
            Log in
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="bg-white p-8 md:p-10 rounded-[24px] max-w-md w-full border border-gray-100 shadow-xl animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3 mt-1">
              <input
                ...
                className="mt-1 h-4 w-4 rounded border-gray-300 text-[#1b3151] focus:ring-[#1b3151] cursor-pointer"
              />
              <label htmlFor="agree" className="text-xs text-gray-500 leading-relaxed cursor-pointer select-none">
                Creating an account means you are okay with our{" "}
                <span className="text-[#1b3151] font-semibold hover:underline">
                  Terms of Service
                </span>{" "}
                and Privacy Policy.
              </label>
          ...
          <div className="text-center mt-6 text-xs text-gray-500">
            ...
            <Link href="/login" className="text-[#1b3151] font-bold hover:underline">
              Sign In
            </Link>
          </div>
        </div>
